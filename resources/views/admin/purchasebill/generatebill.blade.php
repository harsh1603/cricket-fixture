            ...
            <thead>
                <tr style=" border: 0px solid #000;">
                    ...
                    <th style=" border: 0px solid #ddd;text-align: center;width:30%;">
                        <span class="eshead"> ESTIMATE </span>
                    </th>
            ...
            <thead>
                <tr style=" border: 0px solid #000;">
                    <th style=" border: 0px solid #ddd;text-align: center;">
                        ...
                        <span class="colorblue">{{$setting->address}}</span><br>
                    </th>
                ...
                <tr style=" border: 0px solid #000;">
                    ...
                    <th style=" border: 0px solid #ddd;text-align: right;width:40%;">
                        <span class="colorblue"> Date :- </span><span
                            class="dottedborder">{{date('d/m/Y',strtotime($data->created_date))}}</span>
                    </th>
                </tr>
            </thead>
        </table>
            ...
            <thead>
                <tr style=" border: 0px solid #000;">
                    ...
                    <td style=" border: 0px solid #ddd;text-align: left;border-bottom: 1px dotted #4141e5;">
                        {{getCompanyName('name',$data->company_id)}}
                ...
                <tr style=" border: 0px solid #000;">
                    ...
                    <td style=" border: 0px solid #ddd;text-align: left;border-bottom: 1px dotted #4141e5;">
                        {{getCompanyName('gst_no',$data->company_id)}}
                ...
                <tr style=" border: 0px solid #000;">
                    ...
                    <td style=" border: 0px solid #ddd;text-align: left;border-bottom: 1px dotted #4141e5;">
                        {{getCompanyName('address',$data->company_id)}}
                ...
                <tr style=" border: 0px solid #000;">
                    ...
                    <td style=" border: 0px solid #ddd;text-align: left;border-bottom: 1px dotted #4141e5;">
                        {{getCompanyName('mobile',$data->company_id)}}
