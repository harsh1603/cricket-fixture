...
<div style="margin-bottom: 10px;" class="row">
    <div class="col-lg-12">
        <a class="btn btn-success" href="{{ route("admin.bill.add") }}">
            Generate New Bill
        </a>
    </div>
</div>
                    ...
                    <tr data-entry-id="{{ $bill->id }}">
                        ...
                        <td>
                            ...
                            <a class="btn btn-xs btn-success"
                                href="{{route('admin.bill.generateBill',[Crypt::encrypt($bill->id)])}}"
                                title="print"><i class="fa fa-print"></i> </a>
                            @can('bill_delete')
                            <form action="{{ route('admin.bill.destroy', $bill->id) }}" method="POST"
